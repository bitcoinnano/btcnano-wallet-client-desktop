...
Factory.register('TabbedCarousel', module='bitcoinnano_gui.kivy.uix.screens')
...
class ElectrumWindow(App):
    ...
    def on_new_intent(self, intent):
        if intent.getScheme() != 'bitcoinnano':
            return
    ...
    def on_qr(self, data):
        ...
        if is_address(data):
            self.set_URI(data)
            return
        if data.startswith('bitcoinnano:') or data.startswith('bitcoin:N') or data.startswith('bitcoincash:N'):
            self.set_URI(data)
            return
    ...
    def show_pr_details(self, req, status, is_invoice):
        from bitcoinnano.util import format_time
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='bitcoinnano_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='bitcoinnano_gui.kivy.uix.qrcodewidget')
        ...
        self.icon = "icons/bitcoinnano.png"
    ...
    def update_status(self, *dt):
        ...
        if self.network is None or not self.network.is_running():
            ...
            if not self.wallet.up_to_date or server_height == 0:
                ...
                text_1 = text.strip()[:-1] if text.endswith(".") else text.strip()
                status = str(text_1 + ' ' + self.base_unit)
        else:
    ...
    def on_ref_label(self, label, touch):
        if label.touched:
            ...
            Clock.schedule_once(
                lambda dt: self.show_info(_('Text copied to clipboard.\nTap again to display it as QR code.')))
    ...
    def export_private_keys(self, pk_label, addr):
        ...
        self.protected(_("Enter your PIN code in order to decrypt your private key"), show_private_key,
                       (addr, pk_label))
