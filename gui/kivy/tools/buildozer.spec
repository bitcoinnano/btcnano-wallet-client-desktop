...
# (str) Package name
package.name = BitcoinNano

# (str) Package domain (needed for android/ios packaging)
package.domain = org.bitcoinnano
...
requirements = python3crystax, android, openssl, plyer, kivy

# (str) Presplash of the application
#presplash.filename = %(source.dir)s/gui/kivy/theming/splash.png
presplash.filename = %(source.dir)s/icons/bitcoinnano_presplash.png

# (str) Icon of the application
icon.filename = %(source.dir)s/icons/bitcoinnano_launcher.png
