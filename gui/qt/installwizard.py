...
from bitcoinnano import Wallet, WalletStorage
from bitcoinnano.util import UserCancelled, InvalidPassword
...
MSG_GENERATING_WAIT = _("Bitcoin Nano is generating your addresses, please wait...")
MSG_ENTER_ANYTHING = _("Please enter a seed phrase, a master key, a list of "
                       "Bitcoin Nano addresses, or a list of private keys")
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins, storage):
        ...
        self.setWindowTitle('Bitcoin Nano  -  ' + _('Install Wizard'))
        ...
        self.set_icon(':icons/bitcoinnano.png')
        self.show()
        self.raise_()
    ...
    def run_and_get_wallet(self):
        ...
        self.set_layout(vbox, title=_('Bitcoin Nano wallet'))
        ...
        if self.storage.requires_split():
            self.hide()
            msg = _("The wallet '%s' contains multiple accounts, which are no longer supported since Bitcoin Nano 2.7.\n\n"
        ...
        if self.storage.requires_upgrade():
            self.hide()
            msg = _("The format of your wallet '%s' must be upgraded for Bitcoin Nano. This change will not be backward compatible"%path)
            if not self.question(msg):
                return
    ...
    def init_network(self, network):
        message = _("Bitcoin Nano communicates with remote servers to get "
                  "information about your transactions and addresses. The "
                  "servers all fulfil the same purpose only differing in "
                  "hardware. In most cases you simply want to let Bitcoin Nano "
