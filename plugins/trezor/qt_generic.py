...
from bitcoinnano.plugins import hook, DeviceMgr
from bitcoinnano.util import PrintError, UserCancelled, bh2u
from bitcoinnano.wallet import Wallet, Standard_Wallet
    ...
    def request_trezor_init_settings(self, wizard, method, device):
        ...
        if method in [TIM_NEW, TIM_RECOVER]:
            ...
            if method == TIM_MNEMONIC:
                ...
                def set_enabled():
                    from bitcoinnano.keystore import is_xprv
